...
**Experiment C: Advanced Initialization Strategies**
As discussed in the lectures, standard Random Initialization can result in clusters and gaps in the search space. The library supports advanced strategies to mitigate this.
...
3. **OBLESA:**
  ...
  - Does the initial time required for OBLESA to work produces better results (having a bird fly the full limit with less generations)?
...
**Goal:**
Train an agent that can reach **300 point** consistently (fly for 5 minutes).
